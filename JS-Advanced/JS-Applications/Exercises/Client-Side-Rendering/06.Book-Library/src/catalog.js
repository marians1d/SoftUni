import { deleteBook, editBook, getBooks, html, until } from './utility.js';
// list module:
// display all book modules
// add controls (edit, delete)
...
async function loadBooks(ctx) {
    ...
    return books.map(book => bookRow(book, toggleEditor.bind(null, book, ctx), onDelete.bind(null, book, ctx)))
}

async function toggleEditor(book, ctx) {
    ctx.book = book;
